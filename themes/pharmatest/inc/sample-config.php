    ...
    array(
        ...
        'fields'           => array(
            array(
                ...
                'type'         => 'media',
                'url'          => true,
                'title'        => esc_html__( 'Картинка для баннера', 'your-textdomain-here' ),
                'compiler'     => 'true',
    ...
    array(
        ...
        'fields'     => array(
            array(
                'id'          => 'links-gallery',
                'type'        => 'slides',
                'title'       => esc_html__( '', 'your-textdomain-here' ),
                'placeholder' => array(
                    'title'       => esc_html__( 'Заголовок*', 'your-textdomain-here' ),
                    'description' => esc_html__( 'Описание*, * можно не заполнять', 'your-textdomain-here' ),
...
Redux::set_section(
    $opt_name,
    array(
        'title'      => esc_html__( 'Слайдер брендов', 'your-textdomain-here' ),
        'id'         => 'brands-slider-container',
        'subsection' => false,
        'fields'     => array(
            array(
                'id'          => 'brands-slider',
                'type'        => 'slides',
                'title'       => esc_html__( 'Картинки для слайдера', 'your-textdomain-here' ),
                'placeholder' => array(
                    'title'       => esc_html__( 'Заголовок', 'your-textdomain-here' ),
                    'description' => esc_html__( 'Описание*, * можно не заполнять', 'your-textdomain-here' ),
                    'url'         => esc_html__( 'Ссылка', 'your-textdomain-here' ),
...
Redux::set_section(
    $opt_name,
    array(
        'title'      => esc_html__( 'Сертификаты', 'your-textdomain-here' ),
        'id'         => 'certificates-block',
        'subsection' => false,
        'fields'     => array(
            array(
                'id'          => 'certificates',
...
Redux::set_section(
    $opt_name,
    array(
        'title'      => esc_html__( 'Слайдер видео', 'your-textdomain-here' ),
        'id'         => 'slider-video-container',
        'subsection' => false,
        'fields'     => array(
            array(
                'id'          => 'video-slider',
                'type'        => 'slides',
                'title'       => esc_html__( 'Ссылки на видео', 'your-textdomain-here' ),
                'placeholder' => array(
                    'title'       => esc_html__( 'Заголовок*', 'your-textdomain-here' ),
                    'description' => esc_html__( 'Описание*, * можно не заполнять', 'your-textdomain-here' ),
                    'url'         => esc_html__( 'Ссылка', 'your-textdomain-here' ),
    ...
    array(
        ...
        'fields'     => array(
            array(
                'id'          => 'faq1-tab',
                'type'        => 'slides',
                'title'       => esc_html__( 'Софосбувир', 'your-textdomain-here' ),
                'placeholder' => array(
            ...
            array(
                'id'          => 'faq2-tab',
                'type'        => 'slides',
                'title'       => esc_html__( 'Даклатасвир', 'your-textdomain-here' ),
                'placeholder' => array(
                    'title'       => esc_html__( 'Вопрос', 'your-textdomain-here' ),
                    'description' => esc_html__( 'Ответ', 'your-textdomain-here' ),
                    'url'         => esc_html__( 'Ссылка', 'your-textdomain-here' ),
            ...
            array(
                'id'          => 'faq3-tab',
                'type'        => 'slides',
                'title'       => esc_html__( 'Ледипасвир', 'your-textdomain-here' ),
                'placeholder' => array(
                    'title'       => esc_html__( 'Вопрос', 'your-textdomain-here' ),
                    'description' => esc_html__( 'Ответ', 'your-textdomain-here' ),
                    'url'         => esc_html__( 'Ссылка', 'your-textdomain-here' ),
            ...
            array(
                'id'          => 'faq4-tab',
                'type'        => 'slides',
                'title'       => esc_html__( 'Велпатасвир', 'your-textdomain-here' ),
                'placeholder' => array(
                    'title'       => esc_html__( 'Вопрос', 'your-textdomain-here' ),
                    'description' => esc_html__( 'Ответ', 'your-textdomain-here' ),
                    'url'         => esc_html__( 'Ссылка', 'your-textdomain-here' ),
            ...
            array(
                'id'          => 'faq5-tab',
                'type'        => 'slides',
                'title'       => esc_html__( 'Общие вопросы', 'your-textdomain-here' ),
                'placeholder' => array(
                    'title'       => esc_html__( 'Вопрос', 'your-textdomain-here' ),
                    'description' => esc_html__( 'Ответ', 'your-textdomain-here' ),
                    'url'         => esc_html__( 'Ссылка', 'your-textdomain-here' ),
...
Redux::set_section(
    $opt_name,
    array(
        'title'            => esc_html__( 'Ссылки, телефон, почта'),
        ...
        'fields'           => array(
            ...
            array(
                'id'       => 'mail',
                'type'     => 'text',
                'title'    => esc_html__( 'Почта '),
            ),
            array(
                'id'       => 'requisites',
                'type'     => 'textarea',
                'title'    => esc_html__( 'Реквезиты '),
            ),
            array(
                'id'       => 'soc-tg',
                'type'     => 'text',
                'title'    => esc_html__( 'Телеграмм '),
            ),
            array(
                'id'       => 'soc-vk',
                'type'     => 'text',
                'title'    => esc_html__( 'Вконтакте'),
            ),
            array(
                'id'       => 'soc-youtube',
                'type'     => 'text',
                'title'    => esc_html__( 'Youtube'),
            ),
            array(
                'id'       => 'soc-whatsapp',
                'type'     => 'text',
            ...
            array(
                'id'       => 'link-podbor',
                'type'     => 'text',
                'title'    => esc_html__( 'Ссылка на подбор'),
            ),
            array(
                'id'       => 'link-analizi',
                'type'     => 'text',
                'title'    => esc_html__( 'Ссылка на анализы'),
            ),
            array(
                'id'       => 'link-karta',
                'type'     => 'text',
                'title'    => esc_html__( 'Карта сайта'),
            ),
            array(
                'id'       => 'link-politika',
                'type'     => 'text',
                'title'    => esc_html__( 'Политика Конфидициальности'),
            ),
            array(
                'id'       => 'link-soglasie',
                'type'     => 'text',
                'title'    => esc_html__( 'Согласие на обработку пд'),
            ),
